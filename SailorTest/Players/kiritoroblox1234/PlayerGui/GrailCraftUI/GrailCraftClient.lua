...
local v7 = v5:WaitForChild("OpenGrailCraftUI")
local v_u_8 = v6:WaitForChild("RequestGrailCraft")
local v9 = v3:WaitForChild("GrailCraftUI"):WaitForChild("MainFrame")
local v10 = v9:WaitForChild("Frame")
local v11 = v10.CloseButtonFrame:WaitForChild("CloseButton")
local v12 = v10.Content.Holder:WaitForChild("DivineGrailFrame")
...
v7.OnClientEvent:Connect(function()
	...
	v_u_15.Text = "x" .. 3 * v26 .. " Broken Sword"
end)
v13.MouseButton1Click:Connect(function()
	...
	if not v_u_16 then
		...
		local v32, v33, _ = pcall(function()
			...
			return v_u_8:InvokeServer("DivineGrail", v_u_30)
		end)
		if not v32 then
			warn("[GrailCraft] Remote error:", v33)
		end
		task.wait(0.5)
		v_u_16 = false
	end
