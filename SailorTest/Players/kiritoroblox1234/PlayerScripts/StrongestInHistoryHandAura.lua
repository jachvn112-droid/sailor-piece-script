...
local function v_u_9()
	...
	local v7 = v6:FindFirstChild("StrongestInHistory")
	if not v7 then
		return nil
	end
	...
	v_u_3 = v8:FindFirstChild("StrongestInHistoryHandVFX")
	return v_u_3
end
	...
	if p10 and p11 then
		for _, v12 in p11:GetChildren() do
			if v12:IsA("Attachment") then
				local v13 = v12:Clone()
				v13:SetAttribute("StrongestInHistoryHandAura", true)
				v13.Parent = p10
			...
			elseif v12:IsA("ParticleEmitter") or (v12:IsA("Trail") or v12:IsA("Beam")) then
				local v15 = v12:Clone()
				v15:SetAttribute("StrongestInHistoryHandAura", true)
				v15.Parent = p10
		...
		for _, v25 in {
			...
			if v26 then
				for _, v27 in v26:GetChildren() do
					if v27:GetAttribute("StrongestInHistoryHandAura") then
						v27:Destroy()
					end
				end
			end
...
local function v_u_41(p29, p_u_30)
	...
	local v33 = p_u_30.ChildAdded:Connect(function(p31)
		...
		local v32 = p_u_30
		if p31:IsA("Tool") and p31.Name == "Strongest In History" then
			v_u_23(v32)
		end
	end)
	local v34 = v_u_4[p29]
	...
	local v37 = p_u_30.ChildRemoved:Connect(function(p35)
		...
		local v36 = p_u_30
		if p35:IsA("Tool") and p35.Name == "Strongest In History" then
			v_u_28(v36)
		end
	end)
	local v38 = v_u_4[p29]
	...
	if v39 == nil then
		...
		v40 = v39.Name == "Strongest In History"
	end
	if v40 then
		task.wait(0.1)
		v_u_23(p_u_30)
