...
local function v_u_47(p38)
	-- upvalues: (copy) v_u_5, (copy) v_u_15, (copy) v_u_16, (copy) v_u_19
...
local function v_u_67()
	-- upvalues: (ref) v_u_18, (copy) v_u_3, (copy) v_u_13
	if v_u_18 then
...
local function v_u_78(p_u_68)
	-- upvalues: (copy) v_u_5, (copy) v_u_15, (copy) v_u_19, (copy) v_u_16, (copy) v_u_47, (copy) v_u_56
	...
	if v69 and v69.hasDifficulty then
		...
		if v70 then
			...
			if v71 then
				...
				if v72 then
					for _, v_u_73 in ipairs(v_u_19) do
...
local function v_u_89(p_u_79)
	-- upvalues: (copy) v_u_5, (copy) v_u_15, (copy) v_u_17, (copy) v_u_8, (copy) v_u_16, (copy) v_u_11
				...
				if v83 then
					...
					if v84 and v84:IsA("GuiButton") then
						v84.MouseButton1Click:Connect(function()
							-- upvalues: (ref) v_u_17, (copy) p_u_79, (copy) v_u_80, (ref) v_u_8, (ref) v_u_16
							local v88 = os.clock()
							if v_u_17[p_u_79] and v88 < v_u_17[p_u_79] then
								return
							else
								v_u_17[p_u_79] = v88 + 2
...
v12.OnClientEvent:Connect(function(p94)
	-- upvalues: (ref) v_u_20, (copy) v_u_64
	v_u_20 = p94
	v_u_64()
end)
