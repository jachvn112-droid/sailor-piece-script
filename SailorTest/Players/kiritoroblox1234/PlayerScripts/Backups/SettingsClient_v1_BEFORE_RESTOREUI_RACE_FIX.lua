...
function ApplySetting(p99, p100)
	-- upvalues: (copy) v_u_91, (copy) v_u_92, (copy) v_u_6, (copy) v_u_64, (ref) v_u_66, (ref) v_u_65, (copy) v_u_85, (copy) v_u_90, (copy) v_u_5, (copy) v_u_2, (copy) v_u_96, (copy) v_u_98, (copy) v_u_44
