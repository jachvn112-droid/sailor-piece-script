...
local v_u_154 = v_u_38
local v_u_155 = v_u_36
local v_u_156 = v_u_46
local v_u_157 = v_u_40
local v_u_158 = v_u_39
local v_u_159 = v_u_42
local v_u_160 = v_u_37
...
v34.OnClientEvent:Connect(function(p169)
	-- upvalues: (ref) v_u_154, (ref) v_u_158, (ref) v_u_157, (ref) v_u_156, (copy) v_u_6, (copy) v_u_78, (copy) v_u_17, (copy) v_u_60, (copy) v_u_18, (ref) v_u_159, (copy) v_u_84, (copy) v_u_98
	if p169 then
		v_u_154 = p169.Stats or v_u_154
		v_u_158 = p169.SSPity or v_u_158
		v_u_157 = p169.Gems or v_u_157
		if p169.AutoSkip then
			v_u_156 = p169.AutoSkip
		end
		if v_u_6:IsOpen("RerollStatsUI") then
			for v170, v171 in pairs(v_u_154) do
				v_u_78(v170, v171)
			end
			v_u_17.Text = v_u_60(v_u_157) .. " Gems"
			v_u_18.Text = "Pity: " .. v_u_158 .. "/" .. v_u_159
			v_u_84()
			v_u_98()
		end
	end
...
v_u_6:Register("RerollStatsUI", v7, {
	["onClose"] = function()
		-- upvalues: (ref) v_u_161, (copy) v_u_98, (ref) v_u_155, (ref) v_u_160, (copy) v_u_19, (copy) v_u_20, (copy) v_u_53
		v_u_161 = false
		v_u_98()
		if v_u_155 then
			v_u_155 = false
