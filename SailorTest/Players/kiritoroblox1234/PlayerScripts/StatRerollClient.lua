...
local v_u_155 = v_u_50
local v_u_156 = v_u_47
local v_u_157 = v_u_36
local v_u_158 = v_u_41
local v_u_159 = v_u_43
local v_u_160 = v_u_40
local v_u_161 = v_u_39
local v_u_162 = v_u_38
local v_u_163 = v_u_37
local v164 = {
	["Damage"] = "Damage",
	["Defense"] = "Hp",
	["CooldownReduction"] = "CooldownReduction",
...
v34.OnClientEvent:Connect(function(p171)
	-- upvalues: (ref) v_u_162, (ref) v_u_161, (ref) v_u_160, (ref) v_u_159, (ref) v_u_158, (ref) v_u_156, (copy) v_u_6, (copy) v_u_79, (copy) v_u_17, (copy) v_u_61, (copy) v_u_18, (copy) v_u_85, (copy) v_u_99
	if p171 then
		v_u_162 = p171.Stats or v_u_162
		v_u_161 = p171.SSPity or v_u_161
		if p171.PityTier then
			v_u_160 = p171.PityTier
		end
		if p171.PityMax then
			v_u_159 = p171.PityMax
		end
		v_u_158 = p171.Gems or v_u_158
		if p171.AutoSkip then
			v_u_156 = p171.AutoSkip
		end
		if v_u_6:IsOpen("RerollStatsUI") then
			for v172, v173 in pairs(v_u_162) do
				v_u_79(v172, v173)
			end
			v_u_17.Text = v_u_61(v_u_158) .. " Gems"
			v_u_18.Text = v_u_160 .. " Pity: " .. v_u_161 .. "/" .. v_u_159
			v_u_85()
			v_u_99()
		end
	end
...
v_u_6:Register("RerollStatsUI", v7, {
	["onClose"] = function()
		-- upvalues: (ref) v_u_155, (copy) v_u_99, (ref) v_u_157, (ref) v_u_163, (copy) v_u_19, (copy) v_u_20, (copy) v_u_54
		v_u_155 = false
		v_u_99()
		if v_u_157 then
			v_u_157 = false
