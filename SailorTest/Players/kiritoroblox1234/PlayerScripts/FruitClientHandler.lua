...
v3.InputBegan:Connect(function(p42, p43)
	...
	if not p43 then
		local v44 = (p42.KeyCode == Enum.KeyCode.Backspace or p42.KeyCode == Enum.KeyCode.ButtonSelect) and (v_u_18 and (v_u_18.Parent == v_u_4.Character and v_u_18:FindFirstChild("FruitID")))
		if v44 then
