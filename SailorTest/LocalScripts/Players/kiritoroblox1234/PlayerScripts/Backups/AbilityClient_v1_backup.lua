local v872, v873 = pcall(function()
	...
	local v_u_306 = {}
	local function v_u_760(p_u_307)
	...
	local v_u_761 = {}
	v_u_3:WaitForChild("RemoteEvents"):WaitForChild("AbilityResponse").OnClientEvent:Connect(function(p762, p_u_763)
		-- upvalues: (copy) v_u_761, (copy) v_u_760, (copy) v_u_44, (copy) v_u_37, (copy) v_u_299, (copy) v_u_7, (copy) v_u_305, (copy) v_u_4
		if p762 == "SpawnVFX" then
			if p_u_763.IsNPC and (p_u_763.VFXName == "Z" or (p_u_763.VFXName == "X" or (p_u_763.VFXName == "C" or (p_u_763.VFXName == "V" or p_u_763.VFXName == "F")))) then
				local v764 = (p_u_763.NPCModel or "NPC") .. "_" .. p_u_763.VFXName
				local v765 = tick()
				if v_u_761[v764] and v765 - v_u_761[v764] < 1 then
					return
				end
				v_u_761[v764] = v765
				task.spawn(function()
					-- upvalues: (ref) v_u_760, (copy) p_u_763
					v_u_760(p_u_763)
				end)
				local v766 = p_u_763.MovesetType or "Saber"
				if p_u_763.VFXName == "Z" then
					if v766 == "Gojo" then
						local v767 = (p_u_763.NPCModel or "unknown") .. "_Z"
						local v768 = tick()
						local v769
						if v_u_44[v767] and v768 - v_u_44[v767] < 1.5 then
							v769 = false
						else
							v_u_44[v767] = v768
							v769 = true
						...
						if v769 then
							v_u_37:PlayAt("GojoZ", p_u_763.Position)
						end
					elseif v766 == "Sukuna" then
						local v770 = (p_u_763.NPCModel or "unknown") .. "_Z"
						local v771 = tick()
						local v772
						if v_u_44[v770] and v771 - v_u_44[v770] < 1.5 then
							v772 = false
						else
							v_u_44[v770] = v771
							v772 = true
						...
						if v772 then
							v_u_37:PlayAt("SukunaZ", p_u_763.Position)
						end
					elseif v766 == "Jinwoo" then
						local v773 = (p_u_763.NPCModel or "unknown") .. "_Z"
						local v774 = tick()
						local v775
						...
						if v775 then
							v_u_37:PlayAt("JinwooZ", p_u_763.Position)
						end
					elseif v766 == "Ragna" then
						local v776 = (p_u_763.NPCModel or "unknown") .. "_Z"
						local v777 = tick()
						local v778
						...
						if v778 then
							v_u_37:PlayAt("RagnaZ", p_u_763.Position)
						end
					elseif v766 == "Aizen" then
						local v779 = (p_u_763.NPCModel or "unknown") .. "_Z"
						local v780 = tick()
						local v781
						...
						if v781 then
							v_u_37:PlayAt("AizenZ", p_u_763.Position)
						end
					elseif v766 == "QinShi" then
						local v782 = (p_u_763.NPCModel or "unknown") .. "_Z"
						local v783 = tick()
						local v784
						...
						if v784 then
							v_u_37:PlayAt("QinShiZ", p_u_763.Position)
						end
					elseif v766 == "Yuji" then
						local v785 = (p_u_763.NPCModel or "unknown") .. "_Z"
						local v786 = tick()
						local v787
						...
						if v787 then
							v_u_37:PlayAt("YujiZ", p_u_763.Position)
						end
					elseif v766 ~= "Alucard" then
						if v766 == "GojoV2" then
							local v788 = (p_u_763.NPCModel or "unknown") .. "_Z"
							local v789 = tick()
							local v790
							...
							if v790 then
								v_u_37:PlayAt("GojoV2Z", p_u_763.Position)
							end
						elseif v766 ~= "StrongestInHistory" then
							local v791 = (p_u_763.NPCModel or "unknown") .. "_Z"
							local v792 = tick()
							local v793
							...
							if v793 then
								v_u_37:PlayAt("SaberZ", p_u_763.Position)
							end
						end
					end
				elseif p_u_763.VFXName == "X" then
					if v766 == "Gojo" then
						local v794 = (p_u_763.NPCModel or "unknown") .. "_X"
						local v795 = tick()
						local v796
						...
						if v796 then
							v_u_37:PlayAt("GojoX", p_u_763.Position)
						end
					elseif v766 == "Sukuna" then
						local v797 = (p_u_763.NPCModel or "unknown") .. "_X"
						local v798 = tick()
						local v799
						...
						if v799 then
							v_u_37:PlayAt("SukunaX", p_u_763.Position)
						end
					elseif v766 == "Jinwoo" then
						local v800 = (p_u_763.NPCModel or "unknown") .. "_X"
						local v801 = tick()
						local v802
						...
						if v802 then
							v_u_37:PlayAt("JinwooX", p_u_763.Position)
						end
					elseif v766 == "Ragna" then
						local v803 = (p_u_763.NPCModel or "unknown") .. "_X"
						local v804 = tick()
						local v805
						...
						if v805 then
							v_u_37:PlayAt("RagnaX", p_u_763.Position)
						end
					elseif v766 == "Aizen" then
						local v806 = (p_u_763.NPCModel or "unknown") .. "_X"
						local v807 = tick()
						local v808
						...
						if v808 then
							v_u_37:PlayAt("AizenX", p_u_763.Position)
						end
					elseif v766 == "QinShi" then
						local v809 = (p_u_763.NPCModel or "unknown") .. "_X"
						local v810 = tick()
						local v811
						...
						if v811 then
							v_u_37:PlayAt("QinShiX", p_u_763.Position)
						end
					elseif v766 == "Yuji" then
						local v812 = (p_u_763.NPCModel or "unknown") .. "_X"
						local v813 = tick()
						local v814
						...
						if v814 then
							v_u_37:PlayAt("YujiX", p_u_763.Position)
						end
					elseif v766 ~= "Ichigo" and v766 ~= "Alucard" then
						if v766 == "GojoV2" then
							local v815 = (p_u_763.NPCModel or "unknown") .. "_X"
							local v816 = tick()
							local v817
							...
							if v817 then
								v_u_37:PlayAt("GojoV2X", p_u_763.Position)
							end
						elseif v766 ~= "StrongestInHistory" then
							local v818 = (p_u_763.NPCModel or "unknown") .. "_X"
							local v819 = tick()
							local v820
							...
							if v820 then
								v_u_37:PlayAt("SaberX", p_u_763.Position)
							end
						end
					end
				elseif p_u_763.VFXName == "C" then
					if v766 == "Gojo" then
						local v821 = (p_u_763.NPCModel or "unknown") .. "_C"
						local v822 = tick()
						local v823
						...
						if v823 then
							v_u_37:PlayAt("GojoC", p_u_763.Position)
							v_u_37:PlayAt("GojoC_Hold", p_u_763.Position)
						end
					elseif v766 == "Jinwoo" then
						local v824 = (p_u_763.NPCModel or "unknown") .. "_C"
						local v825 = tick()
						local v826
						...
						if v826 then
							v_u_37:PlayAt("JinwooC", p_u_763.Position)
						end
					elseif v766 == "Ragna" then
						local v827 = (p_u_763.NPCModel or "unknown") .. "_C"
						local v828 = tick()
						local v829
						...
						if v829 then
							v_u_37:PlayAt("RagnaC_Startup", p_u_763.Position)
						end
					elseif v766 == "Aizen" then
						local v830 = (p_u_763.NPCModel or "unknown") .. "_C"
						local v831 = tick()
						local v832
						...
						if v832 then
							v_u_37:PlayAt("AizenC", p_u_763.Position)
						end
					elseif v766 == "QinShi" then
						local v833 = (p_u_763.NPCModel or "unknown") .. "_C"
						local v834 = tick()
						local v835
						...
						if v835 then
							v_u_37:PlayAt("QinShiC", p_u_763.Position)
						end
					elseif v766 == "Yuji" then
						local v836 = (p_u_763.NPCModel or "unknown") .. "_C"
						local v837 = tick()
						local v838
						...
						if v838 then
							v_u_37:PlayAt("YujiC_Press", p_u_763.Position)
						end
					elseif v766 ~= "Ichigo" and (v766 ~= "Alucard" and (v766 ~= "GojoV2" and v766 ~= "StrongestInHistory")) then
						local v839 = (p_u_763.NPCModel or "unknown") .. "_C"
						local v840 = tick()
						local v841
						...
						if v841 then
							v_u_37:PlayAt("SaberC_Cast", p_u_763.Position)
							task.delay(3.85, function()
								-- upvalues: (ref) v_u_37, (copy) p_u_763
								v_u_37:PlayAt("SaberC_Beam", p_u_763.Position)
							end)
							task.delay(4.4, function()
								-- upvalues: (ref) v_u_37, (copy) p_u_763
								v_u_37:PlayAt("SaberC_Explosion", p_u_763.Position)
							end)
						end
					end
				elseif p_u_763.VFXName == "V" then
					if v766 == "Gojo" then
						v_u_37:PlayAt("GojoV", p_u_763.Position)
					elseif v766 ~= "Sukuna" and (v766 ~= "Ichigo" and (v766 ~= "Alucard" and v766 ~= "GojoV2")) then
						local _ = v766 == "StrongestInHistory"
					end
				end
			else
				task.spawn(function()
					-- upvalues: (ref) v_u_299, (copy) p_u_763
					v_u_299.SpawnVFX(p_u_763.VFXName, p_u_763.Position, p_u_763.Scale, p_u_763.Duration, p_u_763.AbilityName)
				end)
			end
			if p_u_763.CameraShake then
				task.delay(p_u_763.CameraShake.Delay or 0, function()
					-- upvalues: (copy) p_u_763, (ref) v_u_7
					local v_u_842 = p_u_763.CameraShake.Intensity or 5
					local v_u_843 = p_u_763.CameraShake.Duration or 0.3
					if v_u_7:GetAttribute("DisableScreenShake") then
						return
					else
						local v_u_844 = workspace.CurrentCamera
						if v_u_844 then
							task.spawn(function()
								-- upvalues: (copy) v_u_844, (copy) v_u_843, (copy) v_u_842
								local v845 = tick()
								local _ = v_u_844.CFrame
								while tick() - v845 < v_u_843 do
									local v846 = v_u_842 * (1 - (tick() - v845) / v_u_843)
									local v847 = (math.random() - 0.5) * v846 * 0.1
									local v848 = (math.random() - 0.5) * v846 * 0.1
									v_u_844.CFrame = v_u_844.CFrame * CFrame.new(v847, v848, 0)
									task.wait()
								end
							end)
						end
			...
			if p_u_763.ScreenFlash then
				task.spawn(function()
					-- upvalues: (ref) v_u_305, (copy) p_u_763
					v_u_305(p_u_763.ScreenFlash)
				end)
				return
			end
		elseif p762 == "SpawnKatanaSlashPart1" then
			task.spawn(function()
				-- upvalues: (ref) v_u_299, (copy) p_u_763, (ref) v_u_4
				local v849 = v_u_299.SpawnVFXWithRotation(p_u_763.VFXName, p_u_763.Position, p_u_763.Rotation, p_u_763.Scale, p_u_763.Duration, "KatanaAbilities")
				if v849 then
					v_u_4:AddItem(v849, (p_u_763.Duration or 0.4) + 1)
				end
			end)
			if p_u_763.IsNPC then
				v_u_37:PlayAt("KatanaZ", p_u_763.Position)
			end
			if p_u_763.CameraShake then
				local v_u_850 = p_u_763.CameraShake.Intensity or 3
				local v_u_851 = p_u_763.CameraShake.Duration or 0.2
				if v_u_7:GetAttribute("DisableScreenShake") then
					return
				else
					local v_u_852 = workspace.CurrentCamera
					if v_u_852 then
						task.spawn(function()
							-- upvalues: (copy) v_u_852, (copy) v_u_851, (copy) v_u_850
							local v853 = tick()
							local _ = v_u_852.CFrame
							while tick() - v853 < v_u_851 do
								local v854 = v_u_850 * (1 - (tick() - v853) / v_u_851)
								local v855 = (math.random() - 0.5) * v854 * 0.1
								local v856 = (math.random() - 0.5) * v854 * 0.1
								v_u_852.CFrame = v_u_852.CFrame * CFrame.new(v855, v856, 0)
								task.wait()
							end
						end)
					end
		...
		elseif p762 == "SpawnKatanaSlashPart2" then
			task.spawn(function()
				-- upvalues: (ref) v_u_299, (copy) p_u_763, (ref) v_u_4
				local v857 = v_u_299.SpawnTravelingVFX(p_u_763.VFXName, p_u_763.StartPosition, p_u_763.Direction, p_u_763.TravelDistance, p_u_763.TravelSpeed, p_u_763.Scale, p_u_763.Duration, "KatanaAbilities")
				if v857 then
					v_u_4:AddItem(v857, (p_u_763.TravelDistance or 50) / (p_u_763.TravelSpeed or 70) + 2)
				end
			end)
			if p_u_763.CameraShake then
				local v_u_858 = p_u_763.CameraShake.Intensity or 6
				local v_u_859 = p_u_763.CameraShake.Duration or 0.3
				local v_u_860 = not v_u_7:GetAttribute("DisableScreenShake") and workspace.CurrentCamera
				if v_u_860 then
					task.spawn(function()
						-- upvalues: (copy) v_u_860, (copy) v_u_859, (copy) v_u_858
						local v861 = tick()
						local _ = v_u_860.CFrame
						while tick() - v861 < v_u_859 do
							local v862 = v_u_858 * (1 - (tick() - v861) / v_u_859)
							local v863 = (math.random() - 0.5) * v862 * 0.1
							local v864 = (math.random() - 0.5) * v862 * 0.1
							v_u_860.CFrame = v_u_860.CFrame * CFrame.new(v863, v864, 0)
							task.wait()
						end
					end)
				end
	...
	local v865 = v_u_3:WaitForChild("RemoteEvents"):WaitForChild("AbilityHitSound")
	local v_u_866 = 1
	v865.OnClientEvent:Connect(function(p867)
		-- upvalues: (ref) v_u_866, (copy) v_u_37
		if p867 and p867.Position then
			v_u_37:PlayAt("CombatHit" .. v_u_866, p867.Position)
			v_u_866 = v_u_866 % 7 + 1
		end
	end)
	local v_u_868 = require(v_u_3:WaitForChild("HitboxVisualizer"))
	local v869 = v46:WaitForChild("HitboxVisualize", 5)
	if v869 then
		v869.OnClientEvent:Connect(function(p870)
			-- upvalues: (copy) v_u_868
			if p870.Type == "Box" then
				v_u_868.ShowBox(p870.CFrame, p870.Size, p870.Duration, p870.Color)
				return
			elseif p870.Type == "Sphere" then
				v_u_868.ShowSphere(p870.Position, p870.Radius, p870.Duration, p870.Color)
				return
			elseif p870.Type == "Traveling" then
				v_u_868.ShowTraveling(p870.StartPos, p870.Direction, p870.Size, p870.Speed, p870.Distance, p870.HitboxType, p870.Color)
			elseif p870.Type == "FollowingAOE" then
				local v871 = p870.Character
				if v871 then
					v_u_868.ShowFollowingAOE(v871, p870.Size, p870.Duration, p870.Offset, p870.Color, p870.Shape)
					return
				end
			else
				if p870.Type == "MultiWave" then
					v_u_868.ShowMultiWave(p870.OriginCFrame, p870.Waves)
					return
				end
				if p870.Type == "Explosion" then
					v_u_868.ShowExplosion(p870.Position, p870.Radius, p870.Duration, p870.Color)
					return
				end
				if p870.Type == "StaticBox" then
					v_u_868.ShowStaticBox(p870.StartPos, p870.EndPos, p870.Width, p870.Height, p870.Duration, p870.Color)
				end
			end
		end)
	end
