	...
	local function v_u_29(p23, p24, p25, p26, p27)
		...
		elseif p24 == "Katana" or p24 == "Saber" then
			...
			elseif p24 == "Aizen" then
				...
				elseif p24 == "Rimuru" then
					v_u_7:PlayAt(({ "RimuruM1_1", "RimuruM1_2", "RimuruM1_3" })[v28.rimuruM1], p27)
					v28.rimuruM1 = v28.rimuruM1 % 3 + 1
					if p26 then
						v_u_7:PlayAt("SwordHit" .. v28.swordHit, p27)
						v28.swordHit = v28.swordHit % 2 + 1
					end
				...
				if v35 then
					...
					if v36 then
						...
						elseif v_u_6 then
							...
							elseif p32.WeaponName == "Rimuru" then
								local v72 = v_u_6:FindFirstChild("Rimuru")
								if v72 then
									local v73 = v72:FindFirstChild("SlashVFX")
									if v73 then
										local v74 = ({ 30, -30, 0 })[(v37 - 1) % 3 + 1] or 0
										local v75 = v73:Clone()
										v75.CFrame = v36.CFrame * CFrame.Angles(0, 3.141592653589793, (math.rad(v74)))
										v75.Anchored = false
										...
										v76.Parent = v75
										for v77 = 1, 3 do
											local v78 = v75:FindFirstChild("Slash" .. v77)
											if v78 then
												for _, v79 in v78:GetDescendants() do
													if v79:IsA("ParticleEmitter") then
														v79:Emit(v79:GetAttribute("EmitCount") or 1)
													end
												end
											end
										end
								...
								local v80 = v_u_6:FindFirstChild(p32.WeaponName)
								if v80 then
									local v81 = v80:FindFirstChild("SlashVFX")
									if v81 then
										local v82 = (v37 - 1) % 3 + 1
										local v83 = p32.WeaponName == "Aizen"
										local v84 = v83 and CFrame.identity or (v_u_11[v82] or CFrame.Angles(0, 0, 0))
										local v85 = v83 and 1 or (v_u_12[v82] or 1)
										local v86 = v81:Clone()
										v86.CFrame = v36.CFrame * v84
										if v85 ~= 1 and v86:IsA("BasePart") then
											v86.Size = v86.Size * v85
										end
										v86.Anchored = false
										...
										local v87 = Instance.new("WeldConstraint")
										v87.Part0 = v86
										v87.Part1 = v36
										v87.Parent = v86
										local v88 = v86:FindFirstChild("Slash" .. v82)
										if v88 then
											for _, v89 in ipairs(v88:GetDescendants()) do
												if v89:IsA("ParticleEmitter") then
													v89:Emit(v89:GetAttribute("EmitCount") or 1)
												end
											end
										end
										v_u_3:AddItem(v86, 2)
