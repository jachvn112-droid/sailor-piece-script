...
v3.InputBegan:Connect(function(p33, p34)
	...
	if p34 then
		...
		if v_u_11 then
			...
			local v39 = (p33.KeyCode == Enum.KeyCode.Z or (p33.KeyCode == Enum.KeyCode.X or (p33.KeyCode == Enum.KeyCode.C or (p33.KeyCode == Enum.KeyCode.V or (p33.KeyCode == Enum.KeyCode.ButtonX or (p33.KeyCode == Enum.KeyCode.ButtonY or (p33.KeyCode == Enum.KeyCode.ButtonB or p33.KeyCode == Enum.KeyCode.ButtonL1))))))) and true or p33.KeyCode == Enum.KeyCode.DPadUp
			if v35 then
