...
local v5 = v2:WaitForChild("Remotes"):WaitForChild("ValentineMerchantRemotes")
local v_u_6 = v5:WaitForChild("GetValentineMerchantStock")
local v_u_7 = v5:WaitForChild("PurchaseValentineMerchantItem")
local v8 = v5:WaitForChild("OpenValentineMerchantUI")
local v9 = v2:WaitForChild("Modules")
local v_u_10 = require(v9:WaitForChild("ValentineMerchantConfig"))
...
local v17 = v4:WaitForChild("ValentineMerchantUI"):WaitForChild("MainFrame")
...
local function v_u_84(p_u_42, p_u_43)
	...
	if v48 then
		...
		if v52 then
			...
			if v53 then
				...
				if v54 then
					v54.Image = "rbxassetid://139268654994867"
				end
			end
		end
	end
	...
	if v_u_49 and v_u_51 then
		...
		local function v66()
			...
			if v61 and v61 > 500 then
				v_u_49.Text = tostring(500)
				return
			elseif v60 == v59 then
...
local function v101()
	...
	if v_u_13:IsOpen("ValentineMerchantUI") then
		return
	else
		local v95 = v_u_30()
		if v95 - v_u_23 < v_u_14 then
			...
			if v96.success then
				...
				v97.Text = v98 .. v100
				v_u_94(v96.stock)
				v_u_13:Open("ValentineMerchantUI")
...
v21.MouseButton1Click:Connect(function()
	...
	if v102 - v_u_24 < v_u_14 then
		...
		v_u_24 = v102
		if v_u_13:IsOpen("ValentineMerchantUI") then
			v_u_13:Close("ValentineMerchantUI")
		end
	end
end)
...
v3.InputBegan:Connect(function(p103, p104)
	...
	if not p104 then
		if p103.KeyCode == Enum.KeyCode.Escape and v_u_13:IsOpen("ValentineMerchantUI") then
			if not v_u_13:IsOpen("ValentineMerchantUI") then
				return
			end
			v_u_13:Close("ValentineMerchantUI")
		end
...
v17.Visible = false
v_u_13:Register("ValentineMerchantUI", v17)