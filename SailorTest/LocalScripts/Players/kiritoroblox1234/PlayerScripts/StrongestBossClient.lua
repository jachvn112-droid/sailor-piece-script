...
local v_u_5 = require(v2:WaitForChild("Modules"):WaitForChild("StrongestBossConfig"))
local v_u_6 = require(v2:WaitForChild("Modules"):WaitForChild("NotificationService"))
local v7 = v2:WaitForChild("Remotes")
local v_u_8 = v7:WaitForChild("RequestSpawnStrongestBoss")
local v9 = v7:WaitForChild("StrongestBossResult")
local v10 = v7:WaitForChild("OpenStrongestUI")
local v_u_11 = v7:WaitForChild("RequestAutoSpawnStrongest")
local v12 = v7:WaitForChild("AutoSpawnStrongestUpdate")
local v_u_13 = v4:WaitForChild("StrongestBossUI"):WaitForChild("MainFrame")
