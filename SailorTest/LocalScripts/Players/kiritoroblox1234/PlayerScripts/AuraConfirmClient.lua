...
local v_u_4 = require(v2:WaitForChild("Modules"):WaitForChild("AuraConfig"))
local v_u_5 = v3:WaitForChild("AuraConfirmUI"):WaitForChild("MainFrame")
...
local v_u_13 = v12:WaitForChild("EquipAura")
local v_u_14 = v12:WaitForChild("GetEquippedAura")
...
local function v52(p_u_23)
	...
	v_u_11.Text = p_u_23
	local v29 = v_u_4:GetAura(p_u_23)
