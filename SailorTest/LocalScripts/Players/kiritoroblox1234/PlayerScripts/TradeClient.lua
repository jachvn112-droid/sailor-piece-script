...
local function v_u_72()
	-- upvalues: (copy) v_u_26, (ref) v_u_51
...
local function v_u_76(p73)
	...
	for _, v74 in ipairs(p73 or {}) do
		...
		v_u_57[v75] = (v_u_57[v75] or 0) + v74.quantity
	end
end
local function v_u_77()
	-- upvalues: (copy) v_u_35, (ref) v_u_58, (copy) v_u_8
	if v_u_35 then
		v_u_35.LayoutOrder = -1
		v_u_35.Visible = v_u_58 < v_u_8.MAX_ITEMS_PER_SIDE
	end
end
v_u_68 = function()
	-- upvalues: (copy) v_u_2, (copy) v_u_38, (copy) v_u_8, (copy) v_u_52, (ref) v_u_57, (ref) v_u_61, (copy) v_u_6, (copy) v_u_31, (copy) v_u_7, (ref) v_u_59, (copy) v_u_12, (copy) v_u_40
	...
	for _, v81 in ipairs(v_u_8.TRADABLE_CATEGORIES) do
		local v82 = v_u_52[v81] or {}
		for _, v83 in ipairs(v82) do
			local v84 = v_u_57[v81 .. "_" .. v83.name] or 0
			local v85 = (v83.quantity or 1) - v84
			local v86 = v_u_61[v83.name] or 0
			if v86 > 0 then
...
local function v_u_151()
	-- upvalues: (copy) v_u_70, (copy) v_u_29, (copy) v_u_32, (ref) v_u_56, (copy) v_u_15, (ref) v_u_53, (copy) v_u_16, (copy) v_u_14, (copy) v_u_35, (ref) v_u_55, (copy) v_u_37, (ref) v_u_68, (copy) v_u_38, (copy) v_u_117, (copy) v_u_40
	v_u_70()
	...
	local function v126()
		-- upvalues: (ref) v_u_53, (ref) v_u_16, (ref) v_u_14
		if v_u_53 == "confirming" then
			v_u_16:FireServer()
		elseif v_u_53 == "trading" then
	...
	local function v132()
		-- upvalues: (ref) v_u_55, (ref) v_u_37, (ref) v_u_68, (ref) v_u_38
		v_u_55 = not v_u_55
		v_u_37.Visible = v_u_55
		if v_u_55 then
			v_u_68()
...
local function v_u_164()
	-- upvalues: (copy) v_u_72, (copy) v_u_22, (ref) v_u_62, (copy) v_u_26, (ref) v_u_51, (copy) v_u_10, (ref) v_u_152
	v_u_72()
		...
		if v_u_62 then
			...
			if v_u_159.status == "available" then
				...
				v160.Activated:Connect(function()
					-- upvalues: (ref) v_u_51, (copy) v_u_159, (ref) v_u_10, (ref) v_u_152
					local v161 = v_u_51[v_u_159.userId]
			...
			v_u_51[v_u_159.userId].status = v_u_159.status
		end
	end
	if #v158 == 0 then
...
local function v_u_174(p170)
	-- upvalues: (ref) v_u_50, (ref) v_u_53, (ref) v_u_58, (ref) v_u_57, (ref) v_u_54, (ref) v_u_59, (ref) v_u_55, (copy) v_u_5, (copy) v_u_29, (copy) v_u_32, (copy) v_u_34, (copy) v_u_36, (copy) v_u_43, (copy) v_u_41, (copy) v_u_39, (copy) v_u_40, (copy) v_u_37, (ref) v_u_77, (copy) v_u_44, (copy) v_u_45, (ref) v_u_151, (ref) v_u_68
	v_u_50 = true
	v_u_53 = "trading"
	v_u_58 = 0
	v_u_57 = {}
...
local function v175()
	-- upvalues: (ref) v_u_49, (ref) v_u_50, (ref) v_u_53, (ref) v_u_58, (ref) v_u_57, (ref) v_u_54, (ref) v_u_59, (ref) v_u_55, (copy) v_u_70, (copy) v_u_5
	v_u_49 = true
	v_u_50 = false
	v_u_53 = "trading"
	v_u_58 = 0
...
local function v199(p176)
	-- upvalues: (ref) v_u_50, (ref) v_u_54, (copy) v_u_76, (copy) v_u_34, (copy) v_u_36, (ref) v_u_58, (ref) v_u_77, (copy) v_u_6, (copy) v_u_31, (copy) v_u_7, (copy) v_u_13, (copy) v_u_43, (ref) v_u_53, (copy) v_u_32, (copy) v_u_41, (copy) v_u_44, (copy) v_u_45, (ref) v_u_55, (ref) v_u_68
	if v_u_50 then
		v_u_54 = p176.myItems or {}
		v_u_76(v_u_54)
		...
		v_u_58 = #v_u_54
		v_u_77()
		for v_u_178, v179 in ipairs(v_u_54) do
...
v23.OnClientEvent:Connect(function(p200)
	-- upvalues: (copy) v_u_5, (ref) v_u_50, (ref) v_u_51, (copy) v_u_157
	if v_u_5:IsOpen("TradeSelection") then
		if not v_u_50 then
			local v201 = v_u_51[p200.userId]
...
v17.OnClientEvent:Connect(function(p202)
	-- upvalues: (copy) v_u_28, (copy) v_u_70, (ref) v_u_56, (copy) v_u_11, (copy) v_u_169, (ref) v_u_60, (copy) v_u_8
	...
	local function v207()
		-- upvalues: (ref) v_u_11, (ref) v_u_169, (ref) v_u_60
	...
	v_u_60 = task.delay(v_u_8.REQUEST_DISPLAY_TIME, function()
...
v1.PlayerAdded:Connect(function()
	-- upvalues: (copy) v_u_5, (ref) v_u_50, (copy) v_u_164
	if v_u_5:IsOpen("TradeSelection") and not v_u_50 then
		v_u_164()
	end
end)
...
v24.Activated:Connect(function()
	-- upvalues: (copy) v_u_5, (ref) v_u_152, (ref) v_u_50, (copy) v_u_164
