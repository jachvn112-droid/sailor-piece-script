...
local v_u_4 = require(v2.Modules:WaitForChild("TrueAizenBossConfig"))
...
local v8 = v6:WaitForChild("OpenTrueAizenUI")
local v_u_9 = v7:WaitForChild("RequestSpawnTrueAizen")
local v10 = v7:WaitForChild("TrueAizenBossResult")
local v_u_11 = v7:WaitForChild("RequestAutoSpawnTrueAizen")
local v12 = v7:WaitForChild("AutoSpawnTrueAizenUpdate")
local v_u_13 = v3:WaitForChild("TrueAizenBossUI"):WaitForChild("MainFrame")
local v14 = v_u_13:WaitForChild("Frame")
local v15 = v14.Content:WaitForChild("Holder"):WaitForChild("Holder"):WaitForChild("TrueAizenFrame")
...
v8.OnClientEvent:Connect(function()
	-- upvalues: (copy) v_u_5
	v_u_5:Open("TrueAizenBossUI")
end)
v10.OnClientEvent:Connect(function(p42, _)
	-- upvalues: (copy) v_u_5
	if p42 then
		v_u_5:Close("TrueAizenBossUI")
	end
end)
...
task.spawn(function()
	...
	v_u_5:Register("TrueAizenBossUI", v_u_13)
	v_u_41()
end)